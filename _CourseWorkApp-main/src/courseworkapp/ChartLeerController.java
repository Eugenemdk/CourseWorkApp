...
public class ChartLeerController implements Initializable {
	  private Parent page;
	    private Stage stage;
	    private Scene scene;
    @FXML
    ...
    @FXML
    private Button buyLeerBtnChart;

    @FXML
    private Button sellLeerBtnChart;
    ...
    @FXML
    private StackedAreaChart<NumberAxis, NumberAxis> stackAreaChartLeer;
    ...
    @FXML
    void handleButtonLeerBuy(ActionEvent event) throws IOException {
    ...
    @FXML
    void handleButtonLeerSell(ActionEvent event) throws IOException {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		// TODO Auto-generated method stub
		   NumberAxis xAxis = new NumberAxis();
	        ...
	        stackAreaChartLeer.getData().add(dataSeries1);
	        ...
	        stackAreaChartLeer.getData().add(dataSeries2);
	        ...
	        stackAreaChartLeer.getData().add(dataSeries3);
	}
