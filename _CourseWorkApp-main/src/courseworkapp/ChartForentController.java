...
public class ChartForentController implements Initializable {
	 private Parent page;
	    private Stage stage;
	    private Scene scene;
 @FXML
 ...
 @FXML
 private Button buyForentBtnChart;

 @FXML
 private Button sellForentBtnChart;
 ...
 @FXML
 private StackedAreaChart<NumberAxis, NumberAxis> stackAreaChartForent;
 ...
 @FXML
 void handleButtonForentBuy(ActionEvent event) throws IOException {
 ...
 @FXML
 void handleButtonForentSell(ActionEvent event) throws IOException {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		// TODO Auto-generated method stub
		   NumberAxis xAxis = new NumberAxis();
	        ...
	        stackAreaChartForent.getData().add(dataSeries1);
	        ...
	        stackAreaChartForent.getData().add(dataSeries2);
	        ...
	        stackAreaChartForent.getData().add(dataSeries3);
}
}
