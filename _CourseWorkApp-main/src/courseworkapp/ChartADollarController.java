...
public class ChartADollarController implements Initializable {
	  private Parent page;
	  private Stage stage;
	  private Scene scene;
    @FXML
    ...
    @FXML
    private Button buyADollarBtnChart;

    @FXML
    private Button sellADollarBtnChart;
    ...
    @FXML
    private StackedAreaChart<NumberAxis, NumberAxis> stackAreaChartADollar;
    ...
    @FXML
    void handleButtonADollarBuy(ActionEvent event) throws IOException {
    ...
    @FXML
    void handleButtonADollarSell(ActionEvent event) throws IOException {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		// TODO Auto-generated method stub
		   NumberAxis xAxis = new NumberAxis();
	        ...
	        stackAreaChartADollar.getData().add(dataSeries1);
	        ...
	        stackAreaChartADollar.getData().add(dataSeries2);
	        ...
	        stackAreaChartADollar.getData().add(dataSeries3);
	}
