...
public class ChartRuppeeController implements Initializable {
	  private Parent page;
	    private Stage stage;
	    private Scene scene;
    @FXML
    ...
    @FXML
    private Button buyRuppeeBtnChart;

    @FXML
    private Button sellRuppeeBtnChart;
    ...
    @FXML
    private StackedAreaChart<NumberAxis, NumberAxis> stackAreaChartRuppee;
    ...
    @FXML
    void handleButtonRuppeeBuy(ActionEvent event) throws IOException {
    ...
    @FXML
    void handleButtonRuppeeSell(ActionEvent event) throws IOException {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		// TODO Auto-generated method stub
		   NumberAxis xAxis = new NumberAxis();
	        ...
	        stackAreaChartRuppee.getData().add(dataSeries1);
	        ...
	        stackAreaChartRuppee.getData().add(dataSeries2);
	        ...
	        stackAreaChartRuppee.getData().add(dataSeries3);
	}
